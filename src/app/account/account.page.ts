...
export class AccountPage {
    constructor(private config: Config, public api: ApiService, public navCtrl: NavController, public settings: Settings, public platform: Platform, private appRate: AppRate, private callNumber: CallNumber, private emailComposer: EmailComposer, private socialSharing: SocialSharing) {}
    ngOnInit() {
    }
    goTo(path) {
    ...
    this.callNumber.callNumber("08129970359", true)
